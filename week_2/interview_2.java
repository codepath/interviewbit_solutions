...
interface TextJustificationSoln {
	
	enum Mode {
		Default, Left, Right;
	}

	String[] justify(String text, int length, Mode mode);
	
}

class TextJustificationSolnImpl implements TextJustificationSoln {

	@Override
	public String[] justify(String text, int length, Mode mode) {
		ArrayList<String> words = new ArrayList<>();
		for (String word : text.split("\\s")) words.add(word);
		ArrayList<String> lines = fullJustify(words, length);
